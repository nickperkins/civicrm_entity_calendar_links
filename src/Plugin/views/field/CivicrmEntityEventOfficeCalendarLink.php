 ...
 * @ViewsField("civicrm_entity_event_office_calendar_link")
 */
class CivicrmEntityEventOfficeCalendarLink extends FieldPluginBase {
  ...
  public function render(ResultRow $values) {
    ...
    $url = Url::fromUri($this->eventLink->getEventLink($event, 'office'));
    // append font awesome icon to the link
    $render = [
      '#type' => 'link',
      '#title' => Markup::create('Microsoft 365 (Office)'),
      '#url' => $url,
    ];
    return $render;
  }
